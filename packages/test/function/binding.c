...
static void finalize_function(napi_env env, void* data, void* hint) {
  ...
  NODE_API_CALL_RETURN_VOID(env, napi_call_function(env,
                                                undefined,
                                                js_function,
                                                0,
                                                NULL,
...
static napi_value MakeTrackedFunction(napi_env env, napi_callback_info info) {
  ...
  // be gc-ed.
  NODE_API_CALL(env, napi_get_cb_info(env,
                                  info,
                                  &argc,
                                  &js_finalize_cb,
                                  NULL,
  ...
  NODE_API_CALL(env, napi_create_reference(env,
                                       js_finalize_cb,
                                       1,
                                       &js_finalize_cb_ref));
...
napi_value Init(napi_env env, napi_value exports) {
  ...
  NODE_API_CALL(env, napi_set_named_property(env, exports, "TestNameShort", fn3));

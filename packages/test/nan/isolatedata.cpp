...
NAN_MODULE_INIT(Init) {
  v8::Local<v8::String> name = New<v8::String>("setAndGet").ToLocalChecked();
  v8::Local<v8::Function> func = GetFunction(New<v8::FunctionTemplate>(SetAndGet)).ToLocalChecked();
  Set(target, name, func);
  // Set(target

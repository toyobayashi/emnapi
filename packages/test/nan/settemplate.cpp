...
NAN_MODULE_INIT(MyObject::Init) {
  ...
  SetInstanceTemplate(
      tpl, Nan::New<v8::String>("none").ToLocalChecked(),
      Nan::New<v8::String>("none").ToLocalChecked(), v8::None);
  SetInstanceTemplate(
      tpl, Nan::New<v8::String>("readOnly").ToLocalChecked(),
      Nan::New<v8::String>("readOnly").ToLocalChecked(), v8::ReadOnly);
  SetInstanceTemplate(
      tpl, Nan::New<v8::String>("dontEnum").ToLocalChecked(),
      Nan::New<v8::String>("dontEnum").ToLocalChecked(), v8::DontEnum);
  SetInstanceTemplate(
      tpl, Nan::New<v8::String>("dontDelete").ToLocalChecked(),
      Nan::New<v8::String>("dontDelete").ToLocalChecked(), v8::DontDelete);
